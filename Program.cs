...
namespace Practice_Linq
{
    public class Program
    {
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(el => el.Tournament == "UEFA Euro qualification" && (el.City == "Kharkiv" || el.City == "Kyiv") && el.Home_score > el.Away_score);  // Корегуємо запит !!!
        ...
        static void Query6(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(el => el.Tournament == "FIFA World Cup").Reverse().Take(8);   // Корегуємо запит !!!
